                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Detail Data Anggota</li>
                        </ol>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="btn-group">
                            ...
                            <form action="/dashboard/stop-out/{{ $anggotas->id }}" method="POST">
                                @method('delete')
                                @csrf
                        ...
                        <form method="POST" action="/dashboard/stop-out" class="form theme-form"
                                                    ...
                                                    <div class="row mb-1">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input
                                                                ...
                                                                name="lama_kerja_tahun" type="text"
                                                                id="lama_kerja_tahun"
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input
                                                                ...
                                                                name="lama_kerja_bulan" type="text"
                                                                id="lama_kerja_bulan"
                                                    ...
                                                    <div class="row mb-1">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input
                                                                ...
                                                                value="@currency($anggotas->profession->gaji)" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-1">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input
                                                                ...
                                                                name="pendapatan_lain" type="text"
                                                                id="pendapatan_lain" value="@currency($anggotas->profession->pendapatan_lain)" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-1">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input
                                                                ...
                                                                name="telepon_rumah_add" type="text"
