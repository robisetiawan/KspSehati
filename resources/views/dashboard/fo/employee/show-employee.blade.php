                                                    ...
                                                    <div class="row mb-1">
                                                        ...
                                                        <div class="col">
                                                            <input
                                                                ...
                                                                name="no_identitas" type="text" id="no_identitas" readonly
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card-body p-1">
                                                    ...
                                                    <div class="row mb-1">
                                                        ...
                                                        <div class="col">
                                                            <textarea class="form-control form-control-sm @error('alamat') is-invalid @enderror" name="alamat" readonly type="text"
                                                                id="alamat">{{ old('alamat', $employee->alamat) }}</textarea>
                                                            @error('alamat')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
