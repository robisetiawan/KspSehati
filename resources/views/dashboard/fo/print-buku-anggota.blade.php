    ...
    <div class="container">
        ...
        <div class="container pb-3">
            ...
            <div class="row p-1">
                ...
                <div class="col">
                    : {{ $anggotas->identity->no_identitas }}
                </div>
            </div>
            <!-- *************** -->
            <!-- *************** -->
            ...
            <div class="row p-1">
                ...
                <div class="col">
                    : {{ $anggotas->identity->alamat }}
                </div>
            </div>
            <!-- *************** -->
            <!-- *************** -->
            <div class="row p-1">
                <div class="col-3">RT / RW</div>
                <div class="col">
                    : {{ $anggotas->identity->rt }} / {{ $anggotas->identity->rw }}
                </div>
            </div>
            <!-- *************** -->
            <!-- *************** -->
