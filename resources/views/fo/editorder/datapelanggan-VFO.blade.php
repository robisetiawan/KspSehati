                ...
                <div class="col-sm-12 p-r-0">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body p-1 ">
                            ...
                            <!-- **************************************************************************************************8******  -->
                            <div class="row mb-1">
                                <label class="col-sm-3 col-form-label " for="nama">Enrty Date</label>
                            ...
                            <!-- **************************************************************************************************8******  -->
                            <div class="row mb-1">
                                <label class="col-sm-3 col-form-label" for="nama">Nama Panggilan</label>
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body p-1">
                            ...
                            <div class="row mb-1">
                                ...
                                <label class="col-sm-3 col-form-label" for="nama">Gol Darah</label>
                            ...
                            <!-- **************************************************************************************************8******  -->
                            <div class="row mb-1">
                                <label class="col-sm-3 col-form-label" for="nama">Pekerjaan</label>
                            ...
                            <!-- **************************************************************************************************8******  -->
                            <div class="row mb-1">
                                <label class="col-sm-3 col-form-label" for="nama">Pendidikan</label>
                                <div class="col-sm-4 p-l-0">
                                    <select class="form-select form-select-sm">
                                        <option>SD</option>
                                        <option>SMP</option>
                            ...
                            <!-- **************************************************************************************************8******  -->
                            <div class="row mb-1">
                                <label class="col-sm-3 col-form-label" for="nama">Status Rumah</label>
                                <div class="col-sm-4 p-l-0">
                                    <select class="form-select form-select-sm">
                            ...
                            <!-- **************************************************************************************************8******  -->
                            <div class="row mb-1">
                                <label class="col-sm-3 col-form-label" for="nama">Telp Seluler</label>
                                <div class="col-sm-4 p-l-0">
                                    <input type="text" class="form-control form-control-sm" id="colFormLabelSm" />
                                </div>
                                <div class="col-sm-4 p-l-0">
